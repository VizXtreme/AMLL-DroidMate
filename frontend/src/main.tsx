...
[class*="_lyricLine_"] {
  ...
  font-size: max(max(5vh, 2.5vw), 14px) !important;
    ...
    // Use MutationObserver to ensure style persists
    ...
    const errorMsg = `ensureUnblurStyle error: ${(error as Error)?.message || error}`
