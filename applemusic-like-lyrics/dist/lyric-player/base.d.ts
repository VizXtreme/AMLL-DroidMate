import { Disposable, HasElement, LyricLine, LyricWord, OptimizeLyricOptions } from '../interfaces.ts';
...
export declare abstract class LyricPlayerBase extends EventTarget implements HasElement, Disposable {
     ...
     * 标记用户是否正在进行滚动交互
     */
    protected isUserScrolling: boolean;
...
export declare abstract class LyricLineBase extends EventTarget implements Disposable {
    ...
    setTransform(top?: number, scale?: number, opacity?: number, blur?: number, _force?: boolean, delay?: number, _mode?: LyricLineRenderMode): void;
    rebuildElement(): void;
    /**
     * 判定歌词是否可以应用强调辉光效果
     *
